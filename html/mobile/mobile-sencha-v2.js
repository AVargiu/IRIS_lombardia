...
Ext.define('App.SearchFormPopupPanel', {
    extend: 'Ext.Panel',
    config: {
    ...
    scroll: false,
    layout: 'fit',
    fullscreen: Ext.os.is.Phone ? true : undefined,
    ...
    initComponent: function(){
        ...
        this.itemTpl = new Ext.XTemplate(
            '<tpl if="visibility == true">', 
                '<img width="20" src="'+root_dir_html+'/common/icons/check-round-green.png">', 
            '</tpl>', 
            '<tpl if="visibility == false">', 
                '<img width="20" src="'+root_dir_html+'/common/icons/check-round-grey.png">', 
            '</tpl>', 
