...
PROVO AD IMPLEMENTARE LA PAGINA PASSANDO ALLA VERSIONE SENCHA-TOUCH-2
...
$open_css .= '/sencha-touch-2.4.2/resources/css/sencha-touch.css,';
$open_css .= '/GXM-master-0.2/resources/css/gxm.css';
$open_css .= '">';
echo $open_css;
...
$script_js .= '<script type="text/javascript" src="'.$root_dir_html.'/GXM-master-0.2/src/GXM.loader.js"></script>';
//Per le applicazioni della bottombar: da view-source:http://openlayers.org/dev/examples/mobile-sencha.html:
$script_js .= '<script type="text/javascript" src="'.$root_dir_html.'/mobile/mobile-sencha-v2.js"></script>';
...
$lista_js2load = array();
/*THEMES da CARICARE:*/
array_push($lista_js2load, "/common/tematismi/layers_names.js");
...
//zoneall,
aree_allert_raster,
msg, istantaneo, istantaneo_bis, dpc, neve, temperatura_tiny, neve_tiny
,datistazioni_tiny
//raster_ist
//, layer
...
Ext.Loader.setPath({
    'Ext': root_dir_html+'/sencha-touch-2.4.2/src',
    'Ext.plugin': root_dir_html+'/sencha-touch-2.4.2/src/plugin'
});
...
var carousel1 = Ext.create('Ext.TabPanel', {
	fullscreen: true,
	autoMaximize: true,
	//type: 'dark',
...
new Ext.application({
	...
	this.viewport = Ext.create('Ext.TabPanel', {
...

		{
			    ...
			    app.popup = Ext.create('Ext.Panel', {
                                floating: true,
                                modal: true,
                                centered: true,
                                hideOnMaskTap: true,
