...
//Funqzione per IRIS Lombardia per assegnare un titolo alla scheda del grafico in base a nometipologia:
  ...
  else if (tipologia=='PP') return 'Pluvio';
  else if (tipologia=='UR') return 'Igro';
  else if (tipologia=='PA') return 'Baro';
  else if (tipologia=='DVS') return 'DirVS';
  else if (tipologia=='VVS') return 'VelVS';
  else if (tipologia=='VV') return 'VelV';
  else if (tipologia=='T') return 'Temp';
  else if (tipologia=='RG') return 'RadG';
  else if (tipologia=='RN') return 'RadN';
  else if (tipologia=='DV') return 'DirV';
  else if (tipologia=='N') return 'Nivo';
