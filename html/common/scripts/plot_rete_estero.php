	...
	$result_generale = pg_query($conn,$query_datigenerali);
		...
		//Nel caso della temperatura calcolo anche la temperatura di rugiada:
                    ...
                    while($row = pg_fetch_array($result)) {
                        ...
                        $data_agg = $row[3];
                        //Ora calcolo la temperatura di rugiada:
