...
var style_cum3h = new OpenLayers.Style({
        ...
        new OpenLayers.Rule({
                ...
                filter: new OpenLayers.Filter.Comparison({
                        ...
                        property: "ultimovalore", value: 0.5
                })
        ...
        new OpenLayers.Rule({
                ...
                ,symbolizer: {pointRadius: 6, strokeWidth:0.5, fillColor: "gray", fontSize: "0px"}
        }),
	new OpenLayers.Rule({
                title: " ",
                minScaleDenominator: 2500000,
	...
	new OpenLayers.Rule({
                ...
                ,symbolizer: {pointRadius: 3, strokeWidth:0.5, fillColor: "cyan", fontSize: "0px"}
        })
