...
var style_temp_clust_lm = new OpenLayers.Style({
	pointRadius: 12, strokeColor: "black", strokeWidth: 0.4, fillOpacity: 0.8//, strokeOpacity: 0.5, fillOpacity: 0.3, fillColor: "gray"
        ...
        new OpenLayers.Rule({
                ...
                ,symbolizer: {pointRadius: 12, strokeWidth:0.5, fillColor: "red"}
        }),
	new OpenLayers.Rule({
	...
	new OpenLayers.Rule({
                ...
                ,symbolizer: {strokeWidth:0.5, fillColor: "yellow"}
        }),
	new OpenLayers.Rule({
	...
	new OpenLayers.Rule({
                ...
                ,symbolizer: {strokeWidth:0.5, fillColor: "gray"}
        }),
	new OpenLayers.Rule({
                title: " ",
                minScaleDenominator: 500000,
                symbolizer: {pointRadius: 12, strokeWidth:0.6}
        }),
        new OpenLayers.Rule({
                title: " ",
